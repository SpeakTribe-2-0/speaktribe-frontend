...
const Profile = () => {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      ...
      setDisplayName(currentUser.user_metadata?.full_name || currentUser.user_metadata?.displayName || '');
    ...
    <div className="max-w-3xl mx-auto p-6 pt-24">
      ...
      <div className="mb-6 flex items-center gap-4">
        <img
          ...
          alt="avatar"
          className="w-20 h-20 rounded-full object-cover border-2 border-[#009688]"
        />
        <div>
