// pages/HausaAlphabet.jsx
import React, { useState, useEffect } from "react";
import { BsFillSpeakerFill } from "react-icons/bs";
import alphabets from "../../utils/alphabets/hausaAlphabet ";
...
const HausaAlphabet = () => {
  ...
  useEffect(() => {
    if (!alphabets || !Array.isArray(alphabets) || alphabets.length === 0) {
      console.error("Hausa alphabet data is missing or invalid");
      return;
    }
  }, []);
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <h1 className="text-3xl font-bold text-[#262626] mb-4 text-center">
                  Hausa Alphabets — Day {dayIndex + 1} / {totalDays}
                </h1>
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-lg">
                      <div className="text-center">
                        ...
                        <p className="text-gray-600">
                          {allCorrect
                            ? "Perfect! You're a Hausa alphabet master!"
